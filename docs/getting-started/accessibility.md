...
부트스트랩은 보편적인 웹표준에 따릅니다. and—with minimal extra effort—can be used to create sites that are accessible to those using <abbr title="Assistive Technology" class="initialism">AT</abbr>.

## 콤포넌트 요구사항 (Component requirements)
